...
public class ManageChatServlet extends HttpServlet
{
	...
	/**
	 * Reads chat.properties file creates an object of ChatRoomList and stores
	 * it in ServletContext
	 */
	...
	/**
	 * Allows users to add new rooms after performing minimum validation. Also
	 * saves information to chat.properties files if required by initialization
	 * parameter <code>saveRooms</code>.
	 */
	...
	/**
	 * Adds a new Room to ChatRoomList object and saves it to chat.properties
	 * file if required.
	 */
