...
public class CreateCustomPackageForm {
	...
	private JToolBar jToolBar_createEvent = null;
	...
	protected JFrame getJFrame() {
		if (jFrame == null) {
			...
			jFrame.setTitle("Customise My Package");
	...
	private JPanel getJPanel_body() {
		if (jPanel_body == null) {
			...
			jPanel_body.add(getJToolBar_createEvent(), null);
		}
		return jPanel_body;
	}
	...
	private JToolBar getJToolBar_createEvent() {
		if (jToolBar_createEvent == null) {
			jToolBar_createEvent = new JToolBar();
			jToolBar_createEvent.setFloatable(false);
			jToolBar_createEvent.setFocusable(false);
			jToolBar_createEvent.setOpaque(false);
			jToolBar_createEvent.setBounds(new Rectangle(280, 597, 200, 40));
			jToolBar_createEvent.add(getJButton_createEvent());
		}
		return jToolBar_createEvent;
	}
	...
	private JPanel getJPanel_mealBody() {
		if (jPanel_mealBody == null) {
			...
			jLabel_mealPrice.setBounds(new Rectangle(411, 120, 89, 30));
	...
	public void retrieveEntertainmentByID(String ID){
		...
		getJTable_entertainmentMenu().getColumnModel().getColumn(2).setPreferredWidth(700);
