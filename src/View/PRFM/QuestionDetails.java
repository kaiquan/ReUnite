...
public class QuestionDetails {
	...
	JFrame getJFrame() {
		if (jFrame == null) {
			jFrame = new JFrame();
			jFrame.setTitle("Details of Feedback Question #" + fq.getCode().get(0).toString());
	...
	private JButton getViewButton() {
		if (viewButton == null) {
			...
			viewButton.setBounds(new Rectangle(160, 180, 200, 20));
	...
	public static void main(String[] args){
		QuestionDetails det = new QuestionDetails();
	...
	public QuestionDetails(int code){
		this.code = code;
